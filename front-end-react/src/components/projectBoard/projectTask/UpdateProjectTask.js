        ...
        return (
            <div className="container register-form">&nbsp;
                <div className="m-auto text-left">
                    <Link to={`/projectBoard/${this.state.projectIdentifier}`} className="btn btn-light border-primary">
            ...
            <form onSubmit = {this.onSubmit}>
                <div>&nbsp;</div>
                <div className="note">
                    <h3>Update Project Task</h3>
                    <p>{this.state.projectIdentifier} / {this.state.projectSequence}</p>
                </div>
